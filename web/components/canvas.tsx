...
export default function Canvas({
  ...
  const edges: Edge[] = [
    { from: [nodes.general.x, nodes.general.y], to: [nodes.finance.x, nodes.finance.y] },
    { from: [nodes.general.x, nodes.general.y], to: [nodes.marketing.x, nodes.marketing.y] },
    { from: [nodes.general.x, nodes.general.y], to: [nodes.ops.x, nodes.ops.y] },
  ];
